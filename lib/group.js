...
exports.Group = Class({
  ...
  createTabWorker: function (tab) {
    ...
    for (var eventName in this._workerOn) {
      var handler = this._workerOn[eventName];
      worker.port.on(eventName, (function () {
        handler.apply(this, [worker].concat(Array.prototype.slice.call(arguments)));
      }).bind(this));
    }
  },

...
let style = exports.style = function (aWindow) { // nsiDomWindow
  ...
  let theKid = aWindow.document.createElement("div");
  theKid.innerHTML = 'This browser window is public and viewable by anyone in the session.';

  let mainWindow = aWindow.document.getElementById('main-window');
  //mainWindow.style['paddingTop'] = "20px";
  mainWindow.insertBefore(theKid, mainWindow.firstChild);
